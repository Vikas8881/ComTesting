    ...
    public sealed partial class MainLayout
    {
        ...
        private static List<MenuItem> GetIconSideMenuItems()
        {
            var menus = new List<MenuItem>
            {
                ...
                new MenuItem() { Text = "Product", Icon = "fa fa-fw fa-users", Url = "/Products/newPro"},
                new MenuItem() { Text = "Product Image", Icon = "fa fa-fw fa-users", Url = "/Products/Product Images"}
            };
